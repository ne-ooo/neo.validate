...
[![Tree-shakeable](https://img.shields.io/badge/tree--shakeable-yes-success)](package.json)
...
```typescript
import { escape, unescape, trim, ltrim, rtrim, normalizeEmail, stripLow } from '@lpm.dev/neo.validate'
...
Inspired by [validator.js](https://github.com/validatorjs/validator.js) by chriso. We're grateful for their excellent work serving the JavaScript ecosystem for years.
